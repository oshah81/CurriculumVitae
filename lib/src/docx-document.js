...
import generateDocumentTemplate from '../template/document.template.js';
...
class DocxDocument {
  ...
  createMediaFile(base64String) {
    ...
    const shortid = Math.random().toString(36).substring(1, 12);
    const fileNameWithExtension = `image-${shortid}.${fileExtension}`;
